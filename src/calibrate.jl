"""
    calibrate!(phase::AbstractMatrix{Float32}, ref_row::Int, ref_col::Int; box_size::Int=3)
...
"""
function calibrate!(phase::AbstractMatrix{Float32}, ref_row::Int, ref_col::Int; box_size::Int=3)
